...
Trains an XGBoost regressor for consumption prediction.
This is the primary model for the pipeline.
...
def main():
    """Execute complete XGBoost training pipeline"""

    print(f"\nStarting XGBoost Training at {datetime.now()}")
    ...
    print("\n" + "=" * 70)
    print(f"XGBoost Training Complete! Outputs saved to: {OUTPUT_DIR}")
    print("=" * 70)
